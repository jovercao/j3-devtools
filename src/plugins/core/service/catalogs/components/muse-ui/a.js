export default {
  MuAutoComplete: {
    ...
    props: {
      ...
      scroller: {
        ...
        default: 'frames',
        description:
          '滚动的元素，会监听它的 scroll 事件, 在滚动时会不断更新弹出框的位置'
      },
      maxHeight: {
        name: 'maxHeight',
        type: ['Number'],
      ...
      dataSourceConfig: {
        ...
        description:
          'dataSource 的配置信息，text 显示文本属性名称，value 值的属性名称'
      },
      disableFocusRipple: {
      ...
      filter: {
        ...
        description:
          '过滤器配置，用于过滤 dataSource 里的数据，只显示于输入相关的数据。'
      },
      maxSearchResults: {
  ...
  MuBottomSheet: {
    ...
    events: {
      close: {
        ...
        name: 'close',
        description:
          '当点击遮盖层或者按 esc建触发，会触发close的动作作为参数传入，(reason) => {if(reason == \'overlay\') {// 执行关闭动作}}'
      },
      show: {
        title: 'show',
        name: 'show',
  ...
  MuFlatButton: {
    ...
    props: {
      ...
      href: {
        ...
        default: '',
        description:
          '相当于 a 标签的 href属性，设置之后会渲染成 a 标签，默认是使用button标签'
      },
      to: {
        name: 'to',
        type: ['String', 'Object'],
        ...
        default: '',
        description:
          '表示目标路由的链接。设置之后组件会被渲染成router-link, 当被点击后，内部会立刻把 to 的值传到 router.push()，所以这个值可以是一个字符串或者是描述目标位置的对象。'
      },
      tag: {
        name: 'tag',
        type: ['String'],
    ...
    slots: {
      default: {
        name: 'default',
        description:
          '用来放置 input[type=file] 等特殊的按钮，或者自定义icon、文字'
      }
    },
    events: {
      ...
      keyboardFocus: {
        ...
        name: 'keyboardFocus',
        description:
          '键盘使按钮获取焦点的事件，第一个参数为true 时表示获取焦点，为 false 失去焦点, (isFocus)'
      }
    }
  },
  MuRaisedButton: {
  ...
  MuIconButton: {
    ...
    props: {
      ...
      tooltipPosition: {
        ...
        description:
          '提示文字的位置, [垂直位置]-[水平位置]，垂直位置: top，middle, bottom; 水平位置: left, center, right'
      },
      touch: {
        name: 'touch',
        type: ['Boolean'],
  ...
  'MuCardText Slots': {
    name: 'MuCardText Slots',
    title: 'MuCardText Slots',
    tag: 'mu-card-',
    props: {},
    slots: { default: { name: 'default', description: '用于放置子组件' } },
    events: {}
  ...
  'MuCardActions Slots': {
    name: 'MuCardActions Slots',
    title: 'MuCardActions Slots',
    tag: 'mu-card-',
    props: {},
    slots: { default: { name: 'default', description: '用于放置子组件' } },
    events: {}
  ...
  MuDatePicker: {
    ...
    props: {
      ...
      container: {
        ...
        default: 'dialog',
        description:
          'dialog/inline, 弹出日期的方式， dialog 弹出框， inline 内联弹出显示'
      },
      ...
      firstDayOfWeek: {
        ...
        default: 1,
        description:
          '那一天作为一个星期的开始， 默认星期一， 有些情况可能会设置成星期日(0)'
      },
      mode: {
        name: 'mode',
        type: ['String'],
      ...
      errorText: {
        ...
        default: '',
        description:
          '错误提醒文字，如果此参数有值，那么日期选择框会转为错误的状态, 显示效果将会更改'
      },
      errorColor: {
        name: 'errorColor',
        type: ['String'],
    ...
    events: {
      ...
      change: {
        ...
        name: 'change',
        description:
          '由于用户行为(点击确定按钮)导致 value 值改变时触发事件, 传入 value 属性值'
      }
    }
  },
  MuDialog: {
    ...
    events: {
      close: {
        ...
        name: 'close',
        description:
          '当点击遮盖层或者按下esc键时触发该事件，会传入一个 reason 作为参数，javascript\n (reason) => console.log(reason)'
      },
      show: {
        title: 'show',
        name: 'show',
  ...
  MuDrawer: {
    ...
    props: {
      ...
      docked: {
        ...
        default: true,
        description:
          '是否固定 drawer， 设为 true， 将不会显示遮盖层，也不会触发 close 事件'
      },
      right: {
        name: 'right',
        type: ['Boolean'],
  ...
  MuIcon: {
    ...
    props: {
      value: {
        ...
        default: '',
        description:
          'icon的名称，不同的value 对应不同的icon， 可以去图表集中查找'
      },
      size: {
        name: 'size',
        type: ['Number'],
  ...
  MuMenu: {
    ...
    props: {
      desktop: {
        ...
        default: false,
        description:
          '设置为 true, 菜单将被调整为桌面版的样式，缩小高度和调整padding'
      },
      multiple: {
        name: 'multiple',
        type: ['Boolean'],
      ...
      value: {
        ...
        default: '',
        description:
          '设置以后菜单将为可选择的菜单，当菜单项的value 和 当前 value相等，则菜单项为被选中状态'
      }
    },
    slots: {
      default: {
  ...
  MuIconMenu: {
    ...
    props: {
      ...
      tooltipPosition: {
        ...
        default: 'bottom-center',
        description:
          '提示文字文字, [垂直位置]-[水平位置]，垂直位置: top，middle, bottom; 水平位置: left, center, right'
      },
      value: {
        name: 'value',
        type: [],
  ...
  MuPopover: {
    ...
    events: {
      close: {
        ...
        name: 'close',
        description:
          '当需要关闭时触发此事件，会传入一个 reason （关闭的原因） 作为参数， \n\noverlay: 点击了遮盖层; \noverflow: 滚动出窗口范围; \nclickOutSide: 点击了其它地方; \nesc: 按下 ESC 键.'
      },
      show: {
        title: 'show',
        name: 'show',
  ...
  MuLinearProgress: {
    ...
    props: {
      mode: {
        ...
        description:
          '进度指示器的模式， indeterminate 不确定进度模式，这时 value、min、max 无效, determinate 需要通过改变value值来改变进度显示'
      },
      value: {
        name: 'value',
        type: ['Number'],
  ...
  MuSelectField: {
    ...
    props: {
      ...
      errorText: {
        ...
        default: '',
        description:
          '错误提醒文字，如果此参数有值，那么下拉框会转为错误的状态, 显示效果将会更改'
      },
      errorColor: {
        name: 'errorColor',
        type: ['String'],
  ...
  MuCheckbox: {
    ...
    events: {
      ...
      change: {
        ...
        name: 'change',
        description:
          '同 input[type=checkbox] 元素的change事件一致，传入 value 属性值'
      }
    }
  },
  MuRadio: {
    ...
    events: {
      ...
      change: {
        ...
        name: 'change',
        description:
          '同 input[type=radio] 元素的change事件一致, 传入 value 属性值'
      }
    }
  },
  MuSwitch: {
  ...
  MuSlider: {
    ...
    events: {
      ...
      change: {
        ...
        name: 'change',
        description:
          '用于用户行为(点击，拖拽)导致value发生改变时, 触发事件，传入 value 属性值'
      }
    }
  },
  'MuSnackBar&Toast': {
  ...
  MuStepper: {
    ...
    props: {
      ...
      linear: {
        ...
        default: true,
        description:
          '是否为线性步骤导航，设置为 false，将不再控制 step 组件的 completed 和 disabled 属性'
      },
      orientation: {
        name: 'orientation',
        type: ['String'],
  ...
  MuTextField: {
    ...
    slots: {
      default: {
        name: 'default',
        description:
          '用于和其它组件配合使用，可以保留输入框的样式，但内部表单组件可以放置其它的组件，现在的 selectField datePicer timePicker 都是这种方式'
      }
    },
    events: {
      focus: {
  ...
  MuTimePicker: {
    ...
    props: {
      ...
      container: {
        ...
        default: 'dialog',
        description:
          'dialog/inline, 弹出时间选择的方式， dialog 弹出框， inline 内联弹出显示'
      },
      mode: {
        name: 'mode',
        type: ['String'],
      ...
      errorText: {
        ...
        default: '',
        description:
          '错误提醒文字，如果此参数有值，那么时间选择框会转为错误的状态, 显示效果将会更改'
      },
      errorColor: {
        name: 'errorColor',
        type: ['String'],
  ...
  MuPagination: {
    ...
    props: {
      ...
      pageSize: {
        ...
        default: '',
        description:
          '每页条数, 当同时配置pageSizeOptions的时候并且showSizeChanger为true的时候，优先使用pageSizeOptions，否则将会使用该参数'
      },
      defaultPageSize: {
        ...
        default: 10,
        description:
          '默认的每页条数，只有当showSizeChanger为false并且pageSize没有配置的时候才会生效'
      },
      showSizeChanger: {
  ...
  MuTimeline: {
    ...
    props: {
      lineType: {
        ...
        default: 'solid',
        description:
          '时间轴的线条类型，与border-style具有同样的值，例如solid、dotted等'
      },
      lineColor: {
        name: 'lineColor',
        type: ['String'],
      ...
      iconType: {
        ...
        default: 'solid',
        description:
          '时间点的线条类型，与border-style具有同样的值，例如solid、dotted等'
      },
      iconLine: {
        name: 'iconLine',
        type: ['Number'],
